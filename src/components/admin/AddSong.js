    ...
    return (
        <Base>
            <div>
                ...
                <input value={data.title} placeholder='title of the song' onChange={(e) => { handleChange('title', e.target.value) }} />
                <input value={data.language} placeholder='Language' onChange={(e) => { handleChange('language', e.target.value) }} />
                <input value={data.year} placeholder='year' onChange={(e) => { handleChange('year', e.target.value) }} />
                <input value={data.singer} placeholder='singer' onChange={(e) => { handleChange('singer', e.target.value) }} />
